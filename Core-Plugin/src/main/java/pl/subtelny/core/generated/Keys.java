...
public class Keys {
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<GuildIslandsRecord, GuildsRecord> GUILD_ISLANDS__GUILD_ISLANDS_OWNER_FKEY = Internal.createForeignKey(pl.subtelny.core.generated.Keys.GUILDS_PKEY, GuildIslands.GUILD_ISLANDS, "guild_islands__guild_islands_owner_fkey", GuildIslands.GUILD_ISLANDS.OWNER);
        public static final ForeignKey<IslandersRecord, AccountsRecord> ISLANDERS__ISLANDERS_ID_FKEY = Internal.createForeignKey(pl.subtelny.core.generated.Keys.ACCOUNTS_PKEY, Islanders.ISLANDERS, "islanders__islanders_id_fkey", Islanders.ISLANDERS.ID);
        public static final ForeignKey<IslandersRecord, IslandsRecord> ISLANDERS__ISLANDERS_SKYBLOCK_ISLAND_FKEY = Internal.createForeignKey(pl.subtelny.core.generated.Keys.ISLANDS_PKEY, Islanders.ISLANDERS, "islanders__islanders_skyblock_island_fkey", Islanders.ISLANDERS.SKYBLOCK_ISLAND);
        public static final ForeignKey<IslandersRecord, GuildsRecord> ISLANDERS__ISLANDERS_GUILD_FKEY = Internal.createForeignKey(pl.subtelny.core.generated.Keys.GUILDS_PKEY, Islanders.ISLANDERS, "islanders__islanders_guild_fkey", Islanders.ISLANDERS.GUILD);
        public static final ForeignKey<LoginHistoriesRecord, AccountsRecord> LOGIN_HISTORIES__LOGIN_HISTORIES_ACCOUNT_FKEY = Internal.createForeignKey(pl.subtelny.core.generated.Keys.ACCOUNTS_PKEY, LoginHistories.LOGIN_HISTORIES, "login_histories__login_histories_account_fkey", LoginHistories.LOGIN_HISTORIES.ACCOUNT);
