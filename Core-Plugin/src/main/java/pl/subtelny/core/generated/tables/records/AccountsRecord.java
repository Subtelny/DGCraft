...
public class AccountsRecord extends UpdatableRecordImpl<AccountsRecord> implements Record5<UUID, String, String, Citytype, Timestamp> {

    private static final long serialVersionUID = 1001048637;
    ...
    @Override
    public Row5<UUID, String, String, Citytype, Timestamp> valuesRow() {
    ...
    @Override
    public AccountsRecord value4(Citytype value) {
        setCity(value);
        return this;
    }
    ...
    @Override
    public AccountsRecord values(UUID value1, String value2, String value3, Citytype value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountsRecord(UUID id, String name, String displayName, Citytype city, Timestamp lastOnline) {
        super(Accounts.ACCOUNTS);
