...
public class SkyblockIslandsRecord extends UpdatableRecordImpl<SkyblockIslandsRecord> implements Record6<Integer, Integer, Integer, UUID, Integer, Integer> {

    private static final long serialVersionUID = -1250882180;
    ...
    @Override
    public Row6<Integer, Integer, Integer, UUID, Integer, Integer> valuesRow() {
    ...
    @Override
    public SkyblockIslandsRecord value4(UUID value) {
        setOwner(value);
        return this;
    }
    ...
    @Override
    public SkyblockIslandsRecord values(Integer value1, Integer value2, Integer value3, UUID value4, Integer value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SkyblockIslandsRecord(Integer islandId, Integer x, Integer z, UUID owner, Integer points, Integer extendLevel) {
        super(SkyblockIslands.SKYBLOCK_ISLANDS);
