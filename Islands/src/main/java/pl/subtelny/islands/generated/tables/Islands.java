...
public class Islands extends TableImpl<IslandsRecord> {
    ...
    private static final long serialVersionUID = 1651796973;
     ...
     */
    public final TableField<IslandsRecord, String> SPAWN = createField(DSL.name("spawn"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.islands.type</code>.
     */
    public final TableField<IslandsRecord, Islandtype> TYPE = createField(DSL.name("type"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(pl.subtelny.islands.generated.enums.Islandtype.class), this, "");
