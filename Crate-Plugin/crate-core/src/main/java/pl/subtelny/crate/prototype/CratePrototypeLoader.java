...
public class CratePrototypeLoader {
    ...
    private final DefaultCratePrototypeCreators defaultCratePrototypeCreators;

    @Autowired
    public CratePrototypeLoader(DefaultParsersStrategies defaultParsersStrategies, DefaultCratePrototypeCreators defaultCratePrototypeCreators) {
        this.defaultParsersStrategies = defaultParsersStrategies;
        this.defaultCratePrototypeCreators = defaultCratePrototypeCreators;
    }
    ...
    private CratePrototypeFileParserStrategy getCratePrototypeFileParserStrategy(File file, ItemCrateFileParserStrategy itemCrateFileParserStrategy, CratePrototypeLoadRequest request) {
        List<CratePrototypeCreator> defaultCreators = this.defaultCratePrototypeCreators.getDefaultCratePrototypeCreators(itemCrateFileParserStrategy);
