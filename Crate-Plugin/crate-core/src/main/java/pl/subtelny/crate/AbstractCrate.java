...
public abstract class AbstractCrate implements Crate {
    ...
    public AbstractCrate(CrateKey crateKey, String permission, Set<Player> viewers, Inventory inventory) {
        this.crateKey = crateKey;
        this.permission = permission;
        this.viewers = viewers;
        this.inventory = new CrateInventory(this, inventory);
    }
    ...
    public CrateClickResult click(Player player, int slot) {
        if (!viewers.contains(player) || !player.hasPermission(permission)) {
