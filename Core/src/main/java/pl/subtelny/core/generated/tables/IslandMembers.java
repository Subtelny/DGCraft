...
public class IslandMembers extends TableImpl<IslandMembersRecord> {
    ...
    private static final long serialVersionUID = 516306616;
     ...
     */
    public final TableField<IslandMembersRecord, Islandmembertype> MEMBER_TYPE = createField(DSL.name("member_type"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(pl.subtelny.core.generated.enums.Islandmembertype.class), this, "");
