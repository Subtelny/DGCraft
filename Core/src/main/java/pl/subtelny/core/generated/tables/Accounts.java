...
public class Accounts extends TableImpl<AccountsRecord> {
    ...
    private static final long serialVersionUID = -2066749276;
     ...
     */
    public final TableField<AccountsRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.accounts.display_name</code>.
     */
    public final TableField<AccountsRecord, String> DISPLAY_NAME = createField(DSL.name("display_name"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
