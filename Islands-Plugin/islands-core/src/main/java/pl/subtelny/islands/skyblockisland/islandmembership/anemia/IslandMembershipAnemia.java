package pl.subtelny.islands.skyblockisland.islandmembership.anemia;
...
public class IslandMembershipAnemia {
    ...
    public IslandMembershipAnemia(IslanderId islanderId, IslandId islandId, MembershipType membershipType) {
