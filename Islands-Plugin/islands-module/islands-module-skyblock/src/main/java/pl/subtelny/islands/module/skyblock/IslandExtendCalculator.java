...
public class IslandExtendCalculator {
    ...
    public IslandExtendCalculator(Configuration<SkyblockIslandModuleConfiguration> configuration) {
    ...
    private Cuboid calculateCuboid(IslandCoordinates islandCoordinates, int size) {
        SkyblockIslandModuleConfiguration islandConfiguration = configuration.get();
