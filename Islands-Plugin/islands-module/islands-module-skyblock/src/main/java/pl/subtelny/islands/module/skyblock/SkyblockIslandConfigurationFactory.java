...
public class SkyblockIslandConfigurationFactory {
    ...
    public SkyblockIslandModuleConfiguration createConfiguration(File moduleDir) {
        ...
        return new SkyblockIslandModuleConfiguration(worldName, createEnabled, extendConfiguration, defaultSize, spaceBetweenIslands, schematicFilePath, schematicHeight, moduleDir);
    }
