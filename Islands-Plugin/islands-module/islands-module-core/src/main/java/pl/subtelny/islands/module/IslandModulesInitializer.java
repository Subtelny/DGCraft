...
public class IslandModulesInitializer {
    ...
    private IslandModule<Island> initializeModule(File moduleDirectory) {
        ...
        InitiableIslandModule<Island> module = createModule(moduleDirectory, moduleType);
        module.initialize();
        return module;
    }

    private InitiableIslandModule<Island> createModule(File moduleDirectory, String moduleType) {
        try {
