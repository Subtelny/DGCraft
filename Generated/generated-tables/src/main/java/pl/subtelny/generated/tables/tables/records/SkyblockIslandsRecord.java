...
public class SkyblockIslandsRecord extends UpdatableRecordImpl<SkyblockIslandsRecord> implements Record4<Integer, Integer, Integer, Integer> {

    private static final long serialVersionUID = 1156293494;
    ...
    @Override
    public SkyblockIslandsRecord values(Integer value1, Integer value2, Integer value3, Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SkyblockIslandsRecord(Integer islandId, Integer x, Integer z, Integer extendLevel) {
        super(SkyblockIslands.SKYBLOCK_ISLANDS);
